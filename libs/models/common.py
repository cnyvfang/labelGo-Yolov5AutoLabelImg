...
from libs.detect_utils.datasets import letterbox
...
from libs.detect_utils.torch_utils import time_synchronized





class SELayer(nn.Module):   #自添加 SELayer注意力层
...
# class SwishImplementation(torch.autograd.Function): #自修改 BiFPN
#     @staticmethod
#     def forward(ctx, i):
...
#
# class MemoryEfficientSwish(nn.Module):  #自修改 BiFPN
#     def forward(self, x):
#         return SwishImplementation.apply(x)
#
#
# class Swish(nn.Module): #自修改 BiFPN
#     def forward(self, x):
#         return x * torch.sigmoid(x)


class Concat(nn.Module):    #原生Concat
